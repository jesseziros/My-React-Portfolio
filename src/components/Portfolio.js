  ...
  const projectArray = [
    {
      ...
      Github: "https://github.com/jameslee70/FirstProject",
      ...
      techologies: "Javascript, JQuery, Ajax Call, Third Party API's"
    },
    {
      name: "Doctors Connect",
      image: Project2,
      link: "https://creepy-treat-09091.herokuapp.com/",
      Github: "https://github.com/tedwar52/Project-2",
      ...
      techologies: "Node.js, MySQL/Sequelize, SASS, Bcrypt"
    },
    {
      name: "Fitness Tracker",
      image: Project3,
      link: "https://gentle-crag-01569.herokuapp.com/?id=5fd80f193f39be0017214a1a",
      Github: "https://github.com/jesseziros/Fitness-Tracker",
      ...
      techologies: "Node.js, Api/Html routes, MongoDB/Mongoose"
    },
  ]
  return (
    <div>
      {projectArray.map(project => {
        return <Project name={project.name}  key={project.name} link={project.link} image={project.image} message={project.message} Github={project.Github} techologies={project.techologies} />
      })}
    </div>
  );
}
